...
class Boxcar
{
     ...
     * General sound typically default to silent, but if you changed it, you can force the notification to be silent
     * with the "no-sound" sound name.<br />
     * <br />
     * **Supported sounds**
     * - beep-crisp
     * - beep-soft
    ...
    /**
     * If defined, Boxcar will redirect you to this url when you open the notification from the Notification Center.
     * <br />
     * It can be a http link like http://maps.google.com/maps?q=cupertino or an inapp link
